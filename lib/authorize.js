  ...
  // no querystring
    ...
    // let's listen on logout
        ...
        socket.on('disconnect', function(err) {
            ...
            // a payload is an object that was generate when the function options.claim was executed.
            // usually payload contains some user information and permissions.
            // the token contains as well the payload.
            // a socket that has never authenticated would NOT have a payload at all since the user was not authorized to connect.
            // payload cannot be an empty object otherwise there is a major issue in the login flow.
