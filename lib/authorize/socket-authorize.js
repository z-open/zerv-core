 ...
 */
function socketAuthorize(authOptions, io, coreModule, onConnection) {
  ...
  function onNewSocket(socket) {
    ...
    // a new event could be created to handle the token refresh instead if client needed to request it
    // ..................................
  ...
  async function maintainExistingConnectionAuthorization(currentSocket, connData) {
    try {
      ...
      emitToken(currentSocket, newToken, connData.token, decodedToken.exp);
    } catch (error) {
