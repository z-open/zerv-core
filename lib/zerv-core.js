...
function socketServe(server, options) {
    ...
    options.refresh = _.isFunction(options.refresh) ? options.refresh :generateDefaultJwtToken;
  ...
  // //////////////////////////////////////
    ...
    /**
     * This is the default implementation of the token using JWT specifics.
     * This must generate the iat and exp values.
     * @param {Object} payload
     * @param {Number} expiresInSeconds
     * @returns {String} which the token with the signed payload with the proper iat and exp values
     */
    function generateDefaultJwtToken(payload, expiresInSeconds) {
