...
_.assign(coreModule, transaction);

coreModule.defineTransaction = (requirement, parentTransaction, options) => {
    return transaction.defineTransaction(coreModule, requirement, parentTransaction, options);
};
